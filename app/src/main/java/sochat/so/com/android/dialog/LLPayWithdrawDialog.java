...
public class LLPayWithdrawDialog extends Dialog {
    ...
    private LLPayWithdrawDialog dialog;


    public LLPayWithdrawDialog(@NonNull Context context) {
        super(context, R.style.dialog);
        dialog = this;
    }

    public LLPayWithdrawDialog(@NonNull Context context, @StyleRes int themeResId) {
        super(context, themeResId);
    }

    protected LLPayWithdrawDialog(@NonNull Context context, boolean cancelable, @Nullable OnCancelListener cancelListener) {
        super(context, cancelable, cancelListener);
    }
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        requestWindowFeature(Window.FEATURE_NO_TITLE);
        setContentView(R.layout.dialog_ll_pay_witndraw);
        inits();
        listeners();
    }

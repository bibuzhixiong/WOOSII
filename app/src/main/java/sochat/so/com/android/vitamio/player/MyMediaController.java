...
package sochat.so.com.android.vitamio.player;
...
import sochat.so.com.android.vitamio.util.StringUtils;
import sochat.so.com.android.vitamio.util.Utils;
...
public class MyMediaController extends FrameLayout implements View.OnClickListener{
	...
	private PlayVedioActivity  mPlayerActivity;
...
//					System.out.println("zh:::+++ SHOW_PROGRESS:SHOW_PROGRESS:SHOW_PROGRESS:");
	...
	public void initControllerTools(Activity activity, View contentView, io.vov.vitamio.widget.MediaController.MediaPlayerControl player, PlayVedioActivity playerActivity) {

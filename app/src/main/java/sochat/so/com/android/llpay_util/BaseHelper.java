...
public class BaseHelper {
    ...
    public static void showDialog(Activity context, String strTitle,
                                  String strText, int icon, final DialogCallBack callBack)
    {
        try
        {
    ...
    public static JSONObject string2JSON(String
                                                 str)
    {
        try
        {
    ...
    public static String toJSONString(Object obj)
    {
        ...
        try
        {
            Map<String, Object> map = bean2Parameters(obj);
     ...
     * @return
     */
    public static Map<String, Object> bean2Parameters(Object bean)
    {
        if (bean == null)
        {
            return null;
                        ...
                        && !method.getName().startsWith("getClass"))
                {
                    ...
                    try
                    {
                        ...
                        if (className.equalsIgnoreCase("int"))
                        {
                            ...
                            {
                                Log.e("InvocationTargetExce", e.getMessage(),e);
                            }
                    ...
                    {
                        Log.e("IllegalArgumentExce", e.getMessage(), e);
                    } catch (IllegalAccessException e)
                    {
                        Log.e("IllegalAccessExce", e.getMessage(), e);
                    }
                }
            }
        }
     ...
     * @return
     */
    public static String sortParam(Map<String, Object> order)
    {
        if (null == order){
            return null;
        }
     ...
     * @return
     */
    public static String sortParamForSignCard(Map<String, Object> order)
    {
        if (null == order){
            return null;
        }
